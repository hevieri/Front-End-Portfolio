# 👋 ¡Hola! Soy [Hevieri] y este es mi portfolio de Frontend

Soy desarrolladora Front-End apasionado por crear interfaces modernas, funcionales y atractivas.  
Me gusta transformar ideas en experiencias digitales usando las últimas tecnologías web y bases de datos.

---

## 🚀 Tecnologías que manejo en Front
...
- **Bootstrap** – diseño rápido y adaptable  
- **jQuery** – manipulación del DOM y efectos dinámicos  
- **JavaScript (ES6+)** – lógica y funcionalidad  
- **React.js** – componentes reutilizables y SPA modernas  
- **SQL** – consultas, modelado de datos y gestión de bases relacionales  
